...
class VerCategorias(APIView):
    ...
    def get(self, request):
        try:
            ...
            return Response(
                {
                    "mensaje_de_error": "No existen categorias o no han podido ser encontradas",
                    "excepcion": str(e),
                },
...
class VerCategoria(APIView):
    ...
    def get(self, request, id):
        try:
            ...
            return Response(
                {"mensaje_de_error": "El producto no existe"},
                status=status.HTTP_404_NOT_FOUND,
            )
        except Exception as e:
            return Response(
                {
                    "mensaje_de_error": "No existe la categoria o no ha podido ser encontrada",
                    "excepcion": str(e),
                },
                status=status.HTTP_500_INTERNAL_SERVER_ERROR,
            )
    ...
    def post(self, request):
        try:
            ...
            if serializer.is_valid():
                serializer.save()
                return Response(
                    {"nueva_categoria": serializer.data}, status=status.HTTP_201_CREATED
                )
            else:
                return Response(
                    {"mensaje_de_error": serializer.errors},
    ...
    def put(self, request, id):
        try:
            ...
            if serializer.is_valid():
                serializer.save()
                return Response(
                    {"categoria_editada": serializer.data}, status=status.HTTP_200_OK
                )
            else:
                return Response(
                    {"mensaje_de_error": serializer.errors},
...
class VerProducto(APIView):
    ...
    def get(self, request, id):
        try:
            ...
            return Response(
                {
                    "mensaje_de_error": "Ha ocurrido un error al procesar la solicitud",
                    "excepcion": str(e),
                },
                status=status.HTTP_500_INTERNAL_SERVER_ERROR,
            )
        ...
        try:
            ...
            for serial_data in seriales_data:
                ...
                if seriales_serializer.is_valid():
                    serial = Item(
                        **seriales_serializer.validated_data, producto=productos
                    )
                    serial.save()
            ...
            if precio_dolar is not None:
                productos.precio_bolivares = productos.precio_dolares * Decimal(
                    precio_dolar
                )
            productos.save()
            ...
            return Response(
                {
                    "nuevo_producto": ProductoSerializer(productos).data,
    ...
    def put(self, request, id):
        try:
            ...
            if serializer.is_valid():
                ...
                precio_dolar = obtener_precio_dolar()
                if precio_dolar is not None:
                    producto.precio_bolivares = producto.precio_dolares * Decimal(
                        precio_dolar
                    )
                    producto.save()
                return Response(
                    {"producto_editado": serializer.data}, status=status.HTTP_200_OK
                )
            else:
                return Response(
                    {"mensaje_de_error": serializer.errors},
    ...
    def post(self, request):
        try:
            ...
            if not producto_nombre:
                return Response(
                    {"mensaje_de_error": "Se requiere el nombre del producto"},
                    status=status.HTTP_400_BAD_REQUEST,
                )
            try:
            ...
            return Response(
                {"item_creado": ItemSerializer(item).data},
                status=status.HTTP_201_CREATED,
            )
    ...
    def put(self, request, id):
        try:
            ...
            if serializer.is_valid():
                serializer.save()
                return Response(
                    {"item_editado": serializer.data}, status=status.HTTP_200_OK
                )
            else:
                return Response(
                    {"mensaje_de_error": serializer.errors},
            ...
            return Response(
                {"mensaje_de_error": "El serial no existe"},
                status=status.HTTP_404_NOT_FOUND,
            )
        except Exception as e:
            return Response(
    ...
    def delete(self, request, id):
        try:
            ...
            if producto.cantidad_en_stock > 0:
                ...
                return Response(
                    {"mensaje_de_error": "El stock ya es 0, no se puede reducir más"},
                    status=status.HTTP_400_BAD_REQUEST,
                )

            return Response(
                {
                    "mensaje": "El Item ha sido borrado correctamente y el stock se ha reducido"
                },
                status=status.HTTP_204_NO_CONTENT,
            )
            ...
            return Response(
                {"mensaje_de_error": "El Item no existe"},
                status=status.HTTP_404_NOT_FOUND,
            )

        except Producto.DoesNotExist:
            return Response(
                {"mensaje_de_error": "El Producto asociado no existe"},
                status=status.HTTP_404_NOT_FOUND,
            )
